...
def parse_args():
    ...
    parse.add_argument('--a_dataset', type=str, default="isp", choices=['tw','fs','isp'], help='dataset for experiment')
    parse.add_argument('--b_dataset', type=str, default="wb", choices=['fs','fb','wb'], help='dataset for experiment')
